...
Автоматизированный Telegram бот-помощник для мониторинга состояния спины и предоставления персональных аудио-тренировок.
...
- 🎵 Получение аудио-тренировок в зависимости от уровня боли
- 📱 Простой интерфейс с кнопками для быстрой оценки

### Для администраторов:
- 🔧 Управление аудиосообщениями для каждого уровня боли (1-5)
...
- 🎵 Загружать и управлять аудиосообщениями
...
Аудиосообщения будут автоматически отправляться пользователям в зависимости от их оценки боли.
...
- `audio_messages` - Аудиосообщения для разных уровней боли
...
4. Получает персональное аудиосообщение
5. Каждый день получает напоминание

### Администратор:
1. Отправляет `/admin`
2. Загружает аудио для уровня боли 4
